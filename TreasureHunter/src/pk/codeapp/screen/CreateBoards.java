...
import static pk.codeapp.screen.CreateBoards.paintFrame;
import static pk.codeapp.screen.CreateBoards.startGame;

/**
 *
 * @author Daniel Amador
 */
public class CreateBoards extends javax.swing.JFrame implements MouseListener
{

    /**
     * Creates new form CreateBoards
     */
    ...
    public CreateBoards(String nombre) { 
        initComponents(); 
    ...
    private void initComponents()
    {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pk/codeapp/tools/paint.jpg"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pk/codeapp/tools/linked.jpg"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pk/codeapp/tools/trash.jpg"))); // NOI18N
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateBoards.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new CreateBoards().setVisible(true);
            }
        });
    }
    ...
    public static void iteratorMainLoop() { 
        while (true) { 
            update(); 
